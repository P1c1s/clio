...
#def user_commands():
#    print(RED, "FORK, WAIT, OPEN, CLOSE!!!! SYSTEM CALL ")
def about():
    print(RED, "Commands show a list of most used commands ")
def user_commands():
    print(REDBOLD, "neofetch e bpytop")
    print(REDBOLD, "User")
...
def console_commands():
    ...
    print(WHITEBOLD, "dmesg", WHITE, "      -  Print or control the kernel ring buffer")
    print(WHITEBOLD, "echo", WHITE, "       -  Write arguments to the standard output")
    print(WHITEBOLD, "exit", WHITE, "       -  Exit from the current shell")
    print(WHITEBOLD, "getconf", WHITE, "    -  Query system configuration variables")
...
def network_commands():
    ...
    print(WHITEBOLD, "arp", WHITE, "   -  The arp cache")
    ...
    print(WHITEBOLD, "nmcli", WHITE, "   -  ...")
    print(WHITEBOLD, "tcpdump", WHITE, "    -  Dump traffic on a network")
    #netstat -pnltu
...
def system_commands():
    ...
    print(WHITEBOLD, "memusage -T ./ammo    --__-_-_--_-_-_--_-_-_--_")
    print(WHITEBOLD, "pidof <name>    --__-_-_--_-_-_--_-_-_--_")
    ...
    print(WHITEBOLD, "time", WHITE, "       -  Calculate the time from start to end of process (time speedtest)")
